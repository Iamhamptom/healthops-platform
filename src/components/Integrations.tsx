...
export default function Integrations() {
  return (
    <section className="relative w-full bg-gray-50 py-24 md:py-32 overflow-hidden">
      ...
      {/* ── Connected: Infinite scroll marquee ── */}
          ...
          >
            {[...connected, ...connected].map((item, i) => {
              ...
              return (
                <div
                  key={`a-${i}`}
                  className="group relative flex items-center gap-3 px-5 py-3 rounded-full bg-white border border-gray-100 shadow-sm hover:shadow-md hover:border-green-200 transition-all duration-300 shrink-0 cursor-default"
                >
      ...
      <div className="flex justify-center mb-14">
        <div className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-green-50 border border-green-200">
          ...
          <span className="text-[11px] font-mono text-green-700 tracking-wider uppercase">
