...
export default function VoiceAgentSection() {
  return (
    <section className="relative py-32 px-6 overflow-hidden bg-[#052E16]">
      {/* Background effects */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-emerald-500/[0.04] rounded-full blur-[200px]" />
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="mb-6">
              <span className="uppercase tracking-[0.3em] text-[10px] text-emerald-400/60 font-mono">
                AI Voice Assistant
              </span>
            </div>
            ...
            <p className="text-[15px] text-white/40 leading-relaxed max-w-md mb-10">
              Our voice AI knows everything about VisioHealth — pricing, features,
