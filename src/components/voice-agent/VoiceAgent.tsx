        ...
        <AnimatePresence>
          {!open && (
            <motion.button
              ...
              className="fixed bottom-6 left-6 w-14 h-14 rounded-full bg-emerald-600 shadow-lg shadow-emerald-500/20 flex items-center justify-center hover:bg-emerald-700 hover:shadow-emerald-500/30 transition-all duration-300 z-50"
              title="Talk to VisioHealth AI"
            >
...
function AgentUI({
  ...
  const bubbleUser = "bg-emerald-600 text-white";
    ...
    <div className={`${bg} flex flex-col`}>
      ...
      <div className={`p-5 border-b ${borderColor}`}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className={`text-[14px] font-semibold ${textPrimary}`}>VisioHealth AI</div>
      ...
      <div className="flex flex-col items-center min-h-[320px]">
        ...
        <div className="py-8 flex flex-col items-center gap-4">
          <div className="relative w-28 h-28 flex items-center justify-center">
            ...
            {/* Core orb */}
            <motion.div
              className="w-20 h-20 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-700 shadow-lg shadow-emerald-500/30 flex items-center justify-center"
              animate={
                isConnected
                  ? isSpeaking
      ...
      <div className={`p-5 border-t ${borderColor}`}>
        {isConnected ? (
          ...
          <button
            onClick={onStart}
            className="w-full py-3 rounded-2xl bg-emerald-600 hover:bg-emerald-700 text-white text-[13px] font-medium transition-colors flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/20 hover:shadow-emerald-500/30"
          >
