...
const features = [
  {
    ...
    description:
      "24/7 intelligent receptionist that answers questions, captures patient details, and routes to your team.",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Confirmation flows, cancellation recovery, waitlist auto-fill, and deposit enforcement for maximum capacity.",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Automated post-visit review requests, negative feedback capture, and AI-suggested replies.",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
  ...
  },
  {
    ...
    description:
      "6-month dental recalls, treatment follow-ups, spa rebooking reminders — all on autopilot.",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Capture referrals from any channel, create structured job cards, and route with urgency tags.",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Automated prep instructions and smart reminders that eliminate no-shows and last-minute reschedules.",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Enforce deposits for high-value bookings with automated receipts and instant pay-by-link collection.",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Real-time KPIs: bookings, no-show rates, review scores, patient reactivation, and revenue metrics.",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
