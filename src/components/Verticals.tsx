        ...
        >
          {verticals.map((v) => (
            <motion.div
              ...
              className="group relative bg-gradient-to-br from-white to-gray-50/50 border border-gray-100 rounded-2xl p-8 shadow-sm hover:shadow-lg hover:shadow-green-500/5 hover:border-green-100 hover:bg-gradient-to-br hover:from-green-50/30 hover:to-white hover:-translate-y-0.5 transition-all duration-500"
            >
              {/* Icon */}
              ...
              <div className="pt-6 border-t border-gray-100">
                <div className="flex items-baseline gap-3">
                  <span className="text-green-700/15 text-6xl font-extralight tracking-tight">
                    {v.stat}
                  </span>
