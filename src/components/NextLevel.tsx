...
const products = [
  {
    ...
    forInvestors:
      "Captures the demand side. Every practice on VisioHealth becomes a listing. Patients search by location, specialty, availability, and medical aid acceptance. Revenue: booking fees + featured listings + patient acquisition leads sold to practices.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Enterprise middleware that bridges VisioHealth to any existing healthcare system — GoodX, Healthbridge, hospital HL7/FHIR, lab systems, radiology PACS, and pharmacy dispensing. The universal healthcare API for Africa.",
    forInvestors:
  ...
  },
  {
    ...
    forInvestors:
      "Post-COVID, patients hate physical waiting rooms. This product is a wedge into every practice — even those not ready for full VisioHealth. Standalone pricing at R2,500/month makes it an easy first sale that upsells to the full platform. Viral loop: patients experience it and ask their OTHER doctors why they don't have it.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export default function NextLevel() {
  return (
    <section className="relative py-32 md:py-40 overflow-hidden bg-[#052E16]">
      {/* Background glow */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-emerald-500/[0.03] rounded-full blur-[200px]" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-base md:text-lg text-white/30 font-light max-w-2xl mx-auto leading-relaxed">
            Four new products are joining the VisioHealth platform — each one
        ...
        >
          <p className="text-sm text-white/20 font-mono mb-6">
            These products will launch throughout 2026–2027 as part of the VisioHealth ecosystem.
          </p>
          <Link
            href="/ecosystem"
