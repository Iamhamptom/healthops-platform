      ...
      <AnimatePresence>
        {!open && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 w-14 h-14 rounded-full bg-green-600 shadow-lg shadow-green-500/20 flex items-center justify-center hover:bg-green-700 transition-all duration-300 z-50"
          >
          ...
          >
                  ...
                  <div className={`max-w-[80%] px-3.5 py-2.5 text-[13px] leading-relaxed ${
                    ...
                    {msg.role === "assistant" && (
                      <button
                        ...
                        className="ml-2 inline-flex text-gray-400 hover:text-green-600 transition-colors"
                        title="Listen"
                      >
            ...
            <form onSubmit={handleSend} className="p-3 border-t border-gray-200 bg-white flex gap-2">
              <input
                ...
                className="flex-1 px-3.5 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-[13px] text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-500/10 transition-all"
              />
              <button
                type="submit"
                disabled={loading || !input.trim()}
                className="p-2.5 bg-green-600 rounded-xl hover:bg-green-700 disabled:opacity-30 transition-all"
              >
