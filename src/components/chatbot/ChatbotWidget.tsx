      ...
      <AnimatePresence>
        {!open && (
          <motion.button
            ...
            className="fixed bottom-24 right-6 w-14 h-14 rounded-full bg-green-600 shadow-lg shadow-green-500/20 flex items-center justify-center hover:bg-green-700 transition-all duration-300 z-50"
          >
