    ...
    <div className="p-6 max-w-2xl space-y-6">
      ...
      <form onSubmit={handleSubmit} className="rounded-xl bg-[var(--bg-card)] border border-[var(--border)] p-6 space-y-5">
        ...
        <button
          type="submit"
          disabled={loading}
          className="flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-[var(--primary)] to-[var(--accent)] rounded-lg text-sm font-medium hover:opacity-90 disabled:opacity-50"
        >
      ...
      <div className="rounded-xl bg-[var(--bg-card)] border border-[var(--border)] p-6">
        ...
        <p className="text-sm text-[var(--text-secondary)]">Signed in as <span className="text-white">{userName}</span></p>
      </div>
    </div>
  );
}
