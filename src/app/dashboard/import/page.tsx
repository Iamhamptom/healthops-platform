        ...
        {["Upload", "Map Columns", "Preview", "Done"].map((label, i) => {
          ...
          return (
            <div key={label} className="flex items-center gap-2">
              {i > 0 && <div className={`w-8 h-px ${isDone ? "bg-emerald-500" : "bg-gray-200"}`} />}
      ...
      {step === "upload" && (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          <div
            ...
            onDrop={handleDrop}
            className="border-2 border-dashed border-gray-200 rounded-xl p-12 text-center hover:border-emerald-300 hover:bg-emerald-50/30 transition-all cursor-pointer"
          ...
          <div className="mt-6 grid grid-cols-3 gap-3">
            {[
              ...
              <button
                ...
                className="flex items-center gap-2 p-3 rounded-lg border border-gray-200 hover:border-emerald-200 hover:bg-emerald-50/30 transition-all text-left"
              >
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-4">
              ...
              {PATIENT_FIELDS.map(field => (
                <div key={field.key} className="flex items-center px-4 py-3 gap-4">
                  ...
                  <select
                    ...
                    className="flex-1 border border-gray-200 rounded-lg px-3 py-2 text-[13px] text-gray-700 bg-white focus:border-emerald-500 focus:outline-none"
                  >
          ...
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-2.5 bg-emerald-600 text-white text-sm font-medium rounded-xl hover:bg-emerald-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
              Preview Import
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-4">
          ...
          <div className="flex justify-between">
            ...
            <button
              ...
              disabled={importing}
              className="flex items-center gap-2 px-6 py-2.5 bg-emerald-600 text-white text-sm font-medium rounded-xl hover:bg-emerald-700 disabled:opacity-50 transition-all"
            >
              {importing ? (
                <>
      ...
      {step === "result" && result && (
        <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} className="space-y-4">
          ...
          <div className="flex justify-center gap-3">
            <a href="/dashboard/patients" className="px-6 py-2.5 bg-emerald-600 text-white text-sm font-medium rounded-xl hover:bg-emerald-700 transition-all">
              View Patients
            </a>
            <button
