  ...
  },
  {
    ...
    papers: [
      ...
      },
      {
        ...
        description: "10-channel patient acquisition plan covering GP referral networks, paediatric pipeline, hospital strategy, compliant digital marketing, and VisioHealth OS integration.",
    ...
    papers: [
      {
        ...
        description: "Market sizing for GPs, community health centres, and primary care clinics. Digital adoption, billing patterns, and VisioHealth opportunity.",
        type: "Market Research",
        date: "Q2 2026",
        status: "Planned",
      },
      ...
      {
        title: "VisioHealth OS — Clinical Outcomes Whitepaper",
        description: "First 6-month impact report from VisioHealth client practices. Time savings, patient throughput, billing accuracy, and compliance improvements.",
        type: "Whitepaper",
        date: "Q3 2026",
        status: "Planned",
      },
    ...
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Market intelligence, compliance research, and strategic analysis powering the VisioHealth ecosystem.
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-3 text-center">
          <p className="text-2xl font-bold text-emerald-700 font-serif">{completePapers}</p>
          <p className="text-xs text-emerald-600">Reports Complete</p>
        </div>
