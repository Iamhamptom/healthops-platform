...
const courses = [
  {
    ...
    modules: [
      ...
      "How VisioHealth AI agents think",
  ...
  },
  {
    ...
    title: "VisioHealth OS — Platform Mastery",
    description: "Hands-on training for every feature in VisioHealth OS. From patient management to billing, AI agents to compliance tools.",
    ...
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          We don&rsquo;t just deploy AI — we educate on it. Every VisioHealth client and their staff
            ...
            <div className="p-5">
              <div className="flex items-start justify-between gap-4">
                ...
                {rsvpSent.has(course.id) ? (
                  <div className="flex items-center gap-1.5 text-emerald-600 text-xs font-medium shrink-0 bg-emerald-50 px-3 py-1.5 rounded-lg">
