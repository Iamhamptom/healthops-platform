...
const investorSteps: Step[] = [
  {
    ...
    description: "Meet the VisioHealth team, understand the vision, and review the ecosystem.",
    icon: HeartPulse,
    color: "#8B5CF6",
    details: [
  ...
  },
  {
    ...
    details: [
      ...
      "Product demo — full walkthrough of VisioHealth OS",
    ],
    status: "current",
  },
  {
    ...
    details: [
      ...
      "Welcome as a VisioHealth shareholder",
    ],
    status: "upcoming",
  },
  {
...
const clientSteps: Step[] = [
  {
    ...
    description: "Create your VisioHealth account and set up your practice profile.",
    icon: Users,
    color: "#10b981",
    details: [
      ...
      "Choose subscription plan (Starter / Professional / Enterprise)",
    ],
    status: "complete",
  },
  {
  ...
  },
  {
    ...
    description: "100 qualified leads generated and loaded into your pipeline.",
    icon: Stethoscope,
    color: "#ec4899",
    details: [
      "100 qualified patient leads generated for your area",
      "Leads loaded into VisioHealth patient pipeline",
      "GP referral network introduction package",
  ...
  },
  {
    id: "golive",
    title: "Go Live",
    description: "Your practice is fully operational on VisioHealth OS.",
    icon: HeartPulse,
    color: "#10b981",
    details: [
