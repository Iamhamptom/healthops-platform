    ...
    <div className="p-6 max-w-4xl mx-auto space-y-8">
      ...
      <div className="prose prose-gray max-w-none">
        <div className="bg-gray-50 border-l-4 border-[#8B5CF6] p-6 rounded-r-xl mb-8">
          ...
          <p className="text-sm text-gray-700 leading-relaxed mb-0 mt-3">
            ...
            every feature we build, every decision we make at VisioHealth. When a system saves a doctor
        ...
        <p className="text-sm text-gray-700 leading-relaxed">
          VisioHealth OS exists to give every medical practice in South Africa — and eventually across
        ...
        <p className="text-sm text-gray-700 leading-relaxed">
          Our six products — VisioHealth OS, Placeo Health, Visio Health Integrator, Visio Waiting Room,
          VisioHealth Payer Connect, and VisioMed AI — form one ecosystem with one goal:
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                VisioHealth OS is built to be cleanly audited at any time by any authority. Our audit trail
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                ...
                Every practice that uses VisioHealth can see exactly how their data is handled,
      ...
      <div className="border border-[#8B5CF6]/20 rounded-xl overflow-hidden">
        ...
        <div className="p-6 space-y-4">
          <p className="text-sm text-gray-700 leading-relaxed">
            VisioHealth uses artificial intelligence to assist with triage, patient intake, follow-ups,
          ...
          <p className="text-sm text-gray-700 leading-relaxed">
            That is why every VisioHealth client receives <strong>private, hands-on AI education</strong> as
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 text-center space-y-4">
        <p className="text-sm text-gray-700 leading-relaxed max-w-2xl mx-auto">
          To every doctor who joins VisioHealth — thank you for trusting us with your practice.
        ...
        <div className="pt-4 border-t border-gray-200">
          ...
          <p className="text-xs text-gray-500">Founder — Visio Research Labs</p>
