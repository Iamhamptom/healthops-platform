...
1.2. "Receiving Party" means the individual or entity accessing the VisioHealth Investor Portal and accepting this Agreement.
...
1.4. "Purpose" means the evaluation of a potential investment in, or business relationship with, VisioCorp and the VisioHealth ecosystem.`,
  },
  {
        ...
        <div className="p-4 border-b border-gray-100 bg-white">
          <div className="text-sm text-gray-700 leading-relaxed bg-white border border-gray-100 rounded-lg p-4">
            ...
            <p className="mb-2">
              ...
              VisioHealth platform and ecosystem (the &quot;Disclosing
              Party&quot;);
            </p>
            <p className="mb-2">AND</p>
            <p>
              <strong>The Receiving Party</strong>, being the individual or
              entity accessing the VisioHealth Investor Portal and accepting
              this Agreement.
            </p>
