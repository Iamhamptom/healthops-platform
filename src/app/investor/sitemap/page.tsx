...
const sitemap: SitemapNode[] = [
  {
    ...
    children: [
      ...
      },
      {
        name: "Platform Admin",
        icon: Shield,
        description: "VisioHealth team management panel",
        status: "live",
        children: [
  ...
  },
  {
    ...
    children: [
      ...
      { name: "Availability Feed", icon: Calendar, description: "Real-time slots from VisioHealth OS", status: "concept" },
    ],
  },
  {
...
const statusColors = {
  live: { bg: "bg-emerald-100", text: "text-emerald-700", dot: "bg-emerald-500", label: "Live" },
    ...
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Complete sitemap of the VisioHealth ecosystem. Click any product or module to expand its features.
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-3 text-center">
          <p className="text-2xl font-bold text-emerald-700 font-serif">1</p>
          <p className="text-xs text-emerald-600">Product Live</p>
        </div>
