...
1.1. VisioCorp (Pty) Ltd, a private company incorporated in the Republic of South Africa, operating the VisioHealth OS platform ("VisioCorp", "Service Provider", "we", "us");

AND

1.2. The Client Practice, being the HPCSA-registered healthcare practice subscribing to the VisioHealth OS platform ("Client", "Practice", "you").

1.3. Together referred to as the "Parties" and individually as a "Party".`,
  },
  {
    title: "2. Service Description",
    content: `2.1. VisioCorp provides the VisioHealth OS platform ("Platform"), an AI-powered healthcare practice management system that includes:
...
2.3. VisioCorp reserves the right to modify, update, or improve Platform features, provided that core functionality is maintained.`,
  },
  {
    ...
    content: `3.1. The Platform is offered under three subscription tiers:
  ...
  PROFESSIONAL PLAN — R35,000 per month
    ...
    - Full white-label branding (logo, colours, subdomain, tagline)
...
4.6. VisioCorp will provide reasonable notice when the Practice approaches 80% of their monthly credit allocation.`,
  },
  {
    ...
    content: `5.1. Each subscription plan includes a monthly lead allocation:
  - Core: 50 qualified leads per month
  - Professional: 100 qualified leads per month
  - Enterprise: 200 qualified leads per month
    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          VisioHealth OS client subscription agreement template. This document
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900">
                VisioHealth OS Service Agreement
              </h2>
