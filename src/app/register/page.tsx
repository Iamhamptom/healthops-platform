      ...
      >
        <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-10">
          <div className="text-center mb-10">
            ...
            <h1 className="text-2xl font-light text-white tracking-tight mb-2">Create your account</h1>
            <p className="text-sm text-white/30 font-light">Get started in under 2 minutes</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <p className="text-center text-xs text-white/30 pt-2">
              ...
              <Link href="/login" className="text-white/50 hover:text-white transition-colors duration-300">
                Sign in
              </Link>
            </p>
          </form>
