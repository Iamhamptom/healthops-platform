        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            {[
              ...
              { text: "Approve care smarter", color: "text-emerald-400" },
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <motion.div
              ...
              whileInView="visible"
              viewport={{ once: true }}
              className="rounded-2xl border border-emerald-400/[0.1] bg-emerald-400/[0.02] p-8"
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-light text-emerald-400">Provider Side</h3>
              </div>
