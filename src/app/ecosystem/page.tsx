...
const products = [
  ...
  },
  {
    ...
    description:
      "The healthcare marketplace for Africa. Patients discover practices near them, compare ratings, read reviews, and book via WhatsApp. Every VisioHealth practice auto-listed. The network effect — more practices means more patients, means more practices.",
    investorAngle:
  ...
  },
  {
    ...
    description:
      "Enterprise middleware that bridges VisioHealth to every existing healthcare system — GoodX, Healthbridge, hospital HL7/FHIR, labs, radiology PACS, pharmacy dispensing. The universal healthcare API for Africa. Once connected, switching costs are massive.",
    investorAngle:
  ...
  },
  {
    ...
    investorAngle:
      "The Trojan horse. Standalone at R2,500/month — an easy first sale to practices not ready for full VisioHealth. Viral loop: patients experience it and demand it from their OTHER doctors. Land-and-expand at its finest.",
...
const revenueModel = [
  { product: "VisioHealth Ops", low: 7500, high: 30000, unit: "per practice/mo" },
      ...
      <section data-jess="eco-hero" className="relative pt-40 pb-32 md:pt-48 md:pb-40 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          <motion.div
            ...
            className="max-w-4xl"
          >
            <span className="inline-block text-[11px] font-mono tracking-[0.4em] text-emerald-400/60 uppercase mb-6">
              The Ecosystem
            </span>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-extralight tracking-[-0.04em] leading-[0.95] mb-8">
              One platform.
              <br />
              <span className="text-emerald-400">Five products.</span>
              <br />
              A billion patients.
            </h1>
            <p className="text-lg md:text-xl text-white/35 font-light leading-relaxed max-w-2xl mb-12">
              VisioHealth isn&apos;t a single product — it&apos;s a healthcare operating
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/register"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-emerald-600 text-white text-sm font-mono hover:bg-emerald-500 transition-all duration-300 shadow-lg shadow-emerald-500/20"
              >
                Start Free Trial
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            {marketStats.map((stat) => (
              <motion.div
                key={stat.label}
                variants={fadeUp}
                className="relative text-center p-8 rounded-2xl border border-white/[0.06] bg-white/[0.02] group hover:border-emerald-400/10 hover:bg-emerald-400/[0.02] transition-all duration-500"
              >
                <div className="text-4xl md:text-5xl font-extralight text-emerald-400 mb-2 tracking-tight">
                  {stat.value}
                </div>
                ...
                {/* Animated accent bar */}
                <motion.div
                  className="absolute bottom-0 left-1/2 -translate-x-1/2 h-[2px] bg-gradient-to-r from-transparent via-emerald-400/40 to-transparent"
                  initial={{ width: 0 }}
          ...
          >
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[11px] font-mono tracking-[0.3em] text-emerald-400/60 uppercase">
                Market Breakdown
              </span>
            </div>
      ...
      <section data-jess="eco-problem" className="relative py-24 md:py-32 border-t border-white/[0.04]">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-light tracking-[-0.03em] mb-4">
              Healthcare in Africa — <span className="text-red-400/80">crisis</span> meets <span className="text-emerald-400">opportunity</span>
            </h2>
          </motion.div>
            ...
            >
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={item.stat} className="flex items-start gap-4">
                    <span className="text-lg font-light text-emerald-400/80 font-mono w-16 shrink-0 text-right">{item.stat}</span>
                    <span className="text-sm text-white/40 font-light leading-relaxed">{item.text}</span>
                  </div>
                ))}
              </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-base text-white/30 font-light max-w-2xl mx-auto">
              One patient journey, five products: Placeo discovers → VisioHealth manages →
            ...
            {["Patient searches", "→", "Finds practice", "→", "Checks in", "→", "Sees doctor", "→", "System syncs"].map((step, i) => (
              <span
                ...
                className={`text-[11px] md:text-[12px] font-mono ${
                  step === "→" ? "text-emerald-400/40" : "text-white/30 px-3 py-1.5 rounded-full border border-white/[0.06] bg-white/[0.02]"
                }`}
              >
                {step}
              </span>
                    ...
                    <div className="lg:border-l lg:border-white/[0.04] lg:pl-8">
                      <div className="rounded-xl bg-white/[0.03] border border-white/[0.04] p-6 h-full">
                        <div className="flex items-center gap-2 mb-3">
                          <svg className="w-3.5 h-3.5 text-emerald-400/60" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 015.814-5.519l2.74-1.22m0 0l-5.94-2.28m5.94 2.28l-2.28 5.941" />
                          </svg>
                          <span className="text-[11px] font-mono tracking-[0.15em] uppercase text-emerald-400/50">
                            Investor Angle
                          </span>
                        </div>
                        ...
                        <div className="flex items-center justify-between pt-3 border-t border-white/[0.04]">
                          ...
                          <div className="text-right">
                            ...
                            <div className="text-[13px] font-mono text-emerald-400/60">{product.tam}</div>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <motion.div
            ...
            className="mt-16 rounded-2xl border border-emerald-400/10 bg-emerald-400/[0.03] p-8 md:p-10"
          >
            ...
            <div className="space-y-3">
                  ...
                  <div key={item.product} className="flex items-center gap-4">
                    ...
                    <div className="flex-1 h-8 rounded-lg bg-white/[0.03] overflow-hidden relative">
                      <motion.div
                        ...
                        className="h-full rounded-lg bg-gradient-to-r from-emerald-500/30 to-emerald-400/10 flex items-center px-3"
                      >
                        <span className="text-[11px] font-mono text-emerald-400/80 whitespace-nowrap">
              ...
              <div className="flex items-center gap-4 pt-3 border-t border-white/[0.06]">
                <span className="text-[12px] font-mono text-emerald-400 w-40 shrink-0 text-right font-medium">Total Per Practice</span>
                <div className="flex-1">
                  <span className="text-lg font-light text-emerald-400">R30,500 – R105,000</span>
            ...
            <div className="mt-6 pt-6 border-t border-white/[0.04] grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
              ...
              <div>
                <div className="text-2xl font-light text-emerald-400">10,000 practices</div>
                <div className="text-[12px] font-mono text-emerald-400/50">= R300M–R1B+ MRR</div>
              </div>
            </div>
          </motion.div>
              ...
              <table className="w-full min-w-[640px]">
                <thead>
                  <tr className="border-b border-white/[0.06]">
                    ...
                    <th className="text-center text-[12px] font-mono text-emerald-400 uppercase tracking-wider p-5">
                      VisioHealth
                    </th>
                  ...
                  {competitorComparison.map((row, i) => (
                    <tr key={row.feature} className={i < competitorComparison.length - 1 ? "border-b border-white/[0.03]" : ""}>
                      ...
                      <td className="text-center p-5">
                        {row.us ? (
                          <span className="inline-flex w-6 h-6 rounded-full bg-emerald-400/10 items-center justify-center">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-center">
                  ...
                  <div className="text-right">
                    ...
                    <div className={`text-lg font-light ${
                      phase.status === "active" ? "text-emerald-400" : "text-white/40"
                  ...
                  {card.points.map((point, i) => (
                    <div key={i} className="flex items-start gap-3">
                      <div className={`w-1.5 h-1.5 rounded-full mt-2 shrink-0 ${
                        card.color === "emerald" ? "bg-emerald-400/40" :
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-extralight tracking-[-0.03em] leading-tight mb-6">
              ...
              <br />
              <span className="text-emerald-400">Africa has been waiting for</span>
            </h2>
            <p className="text-base text-white/30 font-light leading-relaxed mb-12 max-w-xl mx-auto">
              ...
              Start with VisioHealth Ops today, or talk to us about the bigger vision.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              <Link
                href="/register"
                className="inline-flex items-center gap-2 px-10 py-4 rounded-full bg-emerald-600 text-white text-sm font-mono hover:bg-emerald-500 transition-all duration-300 shadow-lg shadow-emerald-500/20"
              >
                Start Free Trial
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
            ...
            <div className="max-w-md mx-auto">
              ...
              {submitted ? (
                <motion.div
                  ...
                  className="flex items-center justify-center gap-2 text-emerald-400 font-mono text-sm py-3"
                >
                ...
                <form onSubmit={handleNotify} className="flex gap-3">
                  <input
                    ...
                    required
                    className="flex-1 px-5 py-3 rounded-full bg-white/5 border border-white/10 text-white text-sm font-mono placeholder:text-white/20 focus:outline-none focus:border-emerald-500/40 transition-colors"
                  />
                  <button
                    type="submit"
                    disabled={submitting}
