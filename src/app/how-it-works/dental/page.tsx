...
export default function DentalPage() {
  return (
    <IndustryPage
      ...
      color="#2DD4BF"
      icon={Stethoscope}
      description="From appointment reminders to recall automation, VisioHealth Ops handles everything your receptionist does — 24/7 on WhatsApp. Your team focuses on patient care while AI handles the admin."
      painPoints={[
