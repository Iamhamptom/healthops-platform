...
export default function ENTPage() {
  return (
    <main className="min-h-screen bg-[#052E16] text-white selection:bg-[#86EFAC]/15">
      {/* Nav */}
      <nav className="sticky top-0 z-50 bg-[#052E16]/90 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 text-emerald-300 hover:text-emerald-200 transition-colors text-sm">
            <ArrowLeft className="w-4 h-4" />
            Back to VisioHealth
          </Link>
          <Link
            href="/register"
            className="px-5 py-2 bg-emerald-600 text-white text-sm font-medium rounded-xl hover:bg-emerald-500 transition-colors"
          >
            Start Free Trial
          </Link>
        </div>
      ...
      <section className="relative py-24 md:py-36 px-6 md:px-12">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <span className="text-xs tracking-[0.3em] uppercase text-emerald-400 font-mono mb-5 block">
            ...
            <h1 className="text-4xl md:text-6xl font-light tracking-[-0.03em] text-white mb-6 leading-tight">
              ...
              <span className="text-emerald-300">for ENT specialists.</span>
            </h1>
            <p className="text-lg md:text-xl text-emerald-100/60 max-w-2xl mx-auto leading-relaxed">
              ...
              VisioHealth handles the admin so you can focus on patients.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="border-y border-white/5 py-6 px-6">
        <div className="max-w-5xl mx-auto flex flex-wrap items-center justify-center gap-4 text-xs text-emerald-300/50 font-mono">
          ...
          >
            {workflows.map((w) => (
              <motion.div
                ...
                className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-7 hover:bg-white/[0.05] hover:border-emerald-500/20 transition-all duration-500"
              >
                ...
                <p className="text-emerald-100/40 text-sm leading-relaxed">{w.description}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="py-24 md:py-32 px-6 md:px-12 bg-white/[0.02]">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-emerald-100/50 text-base mt-4 max-w-lg">
              Children need different workflows. VisioHealth adapts appointment types, reminder messaging,
          ...
          >
            {paediatricFeatures.map((f) => (
              ...
              >
                ...
                <span className="text-emerald-100/60 text-sm leading-relaxed">{f}</span>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="py-24 md:py-32 px-6 md:px-12">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-emerald-100/50 text-base mb-10 max-w-lg mx-auto">
              14-day free trial. No credit card required. Set up in under 5 minutes.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/register"
                className="px-8 py-3.5 bg-emerald-600 text-white font-medium text-sm rounded-xl hover:bg-emerald-500 transition-colors shadow-lg shadow-emerald-600/20"
              >
                Start Free Trial
              </Link>
              <Link
                href="/#pricing"
                className="px-8 py-3.5 bg-white/5 text-emerald-300 font-medium text-sm rounded-xl hover:bg-white/10 transition-colors border border-white/10"
              >
                View Pricing
              </Link>
            </div>
      ...
      <footer className="border-t border-white/5 py-12 px-6">
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-emerald-100/20 text-xs leading-relaxed max-w-2xl mx-auto">
            VisioHealth OS is South Africa&apos;s leading AI-powered practice management software for ENT specialists
          ...
          <p className="text-emerald-100/15 text-[11px] font-mono mt-6">
            &copy; {new Date().getFullYear()} Visio Research Labs
          </p>
        </div>
      </footer>
    </main>
