...
export const metadata: Metadata = {
  title: "ENT Practice Management Software — VisioHealth OS | South Africa",
  ...
  openGraph: {
    title: "ENT Practice Management Software — VisioHealth OS",
    ...
    type: "website",
    locale: "en_ZA",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "VisioHealth OS — ENT Practice Management" }],
  },
};
