...
const industries = [
  { slug: "dental", name: "Dental Practice", color: "#34D399", description: "Automate your front desk, manage patient recalls, and grow your practice with AI-powered booking." },
  ...
  { slug: "wellness", name: "Wellness & Spa", color: "#6EE7B7", description: "Manage bookings, client preferences, treatment plans, and product sales in one platform." },
  { slug: "hospital", name: "Hospital & Clinic", color: "#10B981", description: "Multi-department scheduling, ward management, and cross-facility patient tracking." },
  { slug: "gp", name: "General Practice", color: "#059669", description: "Patient management, chronic care follow-ups, medical aid claims, and POPIA compliance." },
  { slug: "salon", name: "Salon & Beauty", color: "#047857", description: "Client booking, stylist scheduling, product tracking, and automated reminders." },
];
    ...
    <>
      ...
      <div className="pt-24 bg-[#030F07]">
        ...
        <section className="px-6 md:px-12 lg:px-24 py-20 max-w-7xl mx-auto relative">
          <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-[#34D399] rounded-full blur-[300px] opacity-[0.04] pointer-events-none" />
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center max-w-3xl mx-auto relative">
            <span className="text-[13px] text-[#34D399] mb-4 block font-mono tracking-wider uppercase">How It Works</span>
          ...
          <div className="space-y-4">
            {steps.map((step, i) => (
              <motion.div
                ...
                className="flex items-start gap-6 bg-[#071A0E] border border-[#34D399]/[0.06] rounded-2xl p-6 md:p-8 hover:border-[#34D399]/15 transition-all duration-300"
              >
                <div className="w-12 h-12 rounded-xl bg-[#34D399]/10 flex items-center justify-center shrink-0">
                  <span className="text-[13px] font-mono font-bold text-[#34D399]">0{i + 1}</span>
                </div>
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-[11px] font-mono text-[#34D399]/50 uppercase tracking-widest">Step {i + 1}</span>
                  </div>
        ...
        <section className="px-6 md:px-12 lg:px-24 py-20 bg-[#030F07]">
          <div className="max-w-4xl mx-auto text-center">
            <div className="w-12 h-12 rounded-xl bg-[#34D399]/10 flex items-center justify-center mx-auto mb-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {["Audit Logging", "Role-Based Access", "Consent Tracking", "Data Encryption"].map(item => (
                <div key={item} className="flex items-center gap-2 justify-center bg-[#071A0E] border border-[#34D399]/[0.06] rounded-xl py-3 px-4">
                  <svg className="w-4 h-4 text-[#34D399]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
        ...
        <section className="px-6 md:px-12 lg:px-24 py-20 bg-[#FAFAF8]">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <span className="text-[13px] text-[#34D399] mb-4 block font-mono tracking-wider uppercase">Built For You</span>
              ...
              {industries.map((ind, i) => (
                ...
                >
                  <Link
                    ...
                    className="group block glow-card bg-white rounded-2xl border border-[#F0F0EC] hover:border-[#34D399]/20 p-6 transition-all duration-300 h-full"
                  >
                    ...
                    <h3 className="text-[16px] font-semibold text-[#1A1A1A] mb-2 group-hover:text-[#059669] transition-colors">{ind.name}</h3>
                    <p className="text-[13px] text-[#9B9B9B] leading-relaxed mb-4">{ind.description}</p>
                    <span className="text-[13px] text-[#34D399] font-medium flex items-center gap-1 group-hover:gap-2 transition-all font-mono">
                      See how it works
        ...
        <section className="px-6 md:px-12 lg:px-24 py-20 bg-[#030F07]">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link
              href="/register"
              className="inline-flex items-center gap-2 px-8 py-3.5 bg-[#34D399] text-[#030F07] font-semibold text-[15px] rounded-full hover:bg-[#6EE7B7] transition-all duration-300 shadow-[0_0_30px_rgba(52,211,153,0.3)]"
            >
              Start Free Trial
