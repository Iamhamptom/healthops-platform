    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#030F07] relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-[14px] text-white/40">Sign in to your practice dashboard</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-[#071A0E] rounded-2xl border border-[#6EE7B7]/[0.06] p-8 space-y-5">
          ...
          <p className="text-center text-[13px] text-white/30">
            ...
            <Link href="/register" className="text-[#6EE7B7] font-medium hover:underline">
              Get started
            </Link>
          </p>
        </form>

        <p className="text-center text-[12px] text-white/20 mt-6 font-mono">
