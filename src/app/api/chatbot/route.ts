...
const CHATBOT_SYSTEM = `You are a friendly, professional healthcare practice assistant chatbot on the VisioHealth Ops website. You help potential and existing patients with:
